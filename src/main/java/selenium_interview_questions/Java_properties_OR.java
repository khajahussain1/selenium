...
public class Java_properties_OR {
	...
	public Java_properties_OR() {
		...
		try {
			...
			FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"/src/main/java/selenium_interview_questions/OR1");
			pro.load(fis);
			fis.close();
		} catch (IOException e) {
	...
	public By getLocator(String WebElementName) throws Exception {
		...
		String str = pro.getProperty(WebElementName);
